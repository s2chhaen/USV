...
class MPU9250:
    ...
    def magCalib(self):
        ...
        print("\nkeep IMU device horizontal and it will read x y z axis offset value after 5 seconds\n")
        time.sleep(5)
        ...
        print("flip IMU device and keep it horizontal and it will read all axises offset value after 5 seconds\n")
        time.sleep(5)
        print("start read all axises offset value\n")
        self.readMagnet()
        magTemp[6] = Mag[0]
