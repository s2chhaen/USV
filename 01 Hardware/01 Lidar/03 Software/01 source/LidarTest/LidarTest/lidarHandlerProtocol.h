...
enum lidarCmd{
	LIDAR_INIT_N_RESET = 0x10, //OK
	OP_MODE_SEL = 0x20,
	MEASURED_DATA_REQ = 0x30, //OK
	STATUS_REQ = 0x031,//Nur für LMS2xx möglich OK
	ERROR_OR_TEST_TELEGRAM_REQ = 0x32,//OK
	OP_DATA_COUNTER_REQ = 0x35,//OK
	AVG_MEASURED_DATA_REQ = 0x36,//OK
	SEG_MEASURED_DATA_REQ = 0x37,//OK
	LIDAR_TYPE_REQ = 0x3A,//OK
	MEASURED_CONFIG_CHANGE = 0x3B,
	MEASURED_DATA_WITH_FIELD_DATA_REQ = 0x3E,//OK
	SEG_AVG_MEASURED_DATA_REQ = 0x3F,//OK
	FIELD_ABC_CONFIG = 0x40,
	ACTIVE_FIELD_SET_CHANGE = 0x41,
	PWD_CHANGE = 0x42,
	SEG_MEASURED_DATA_AND_REFLECTANCE_REQ = 0x44,//OK
	FIELD_REQ = 0x45,//OK
	LEARNING_MODE_START = 0x46,
	FIELDS_STATUS_OUT_REQ = 0x4A,//OK
	BAUDRATE_OR_LIDAR_TYPE_DEF = 0x66,
	ANGLE_RNG_POSITIONING_SUP = 0x69,
	LIDAR_CONFIG_P1_REQ = 0x74,//Nur für LMS2xx möglich OK
	MEASURED_DATA_WITH_REFLECTANCE_REQ = 0x75,//OK
	MEASURED_DATA_IN_XY_COORD_REQ = 0x76,//OK
	LIDAR_CONFIG_P1 = 0x77,//Nur für LMS2xx möglich
	LIDAR_CONFIG_P2_REQ = 0x7B,//Nur für LMS2xx möglich OK
