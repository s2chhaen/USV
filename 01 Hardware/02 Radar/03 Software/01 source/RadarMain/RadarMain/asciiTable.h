...
enum asciiChar{
    ASCII_NULL_CHAR,         ASCII_SOH_CHAR,          ASCII_STX_CHAR,          ASCII_ETX_CHAR,          ASCII_EOT_CHAR,//4
    ASCII_ENQ_CHAR,          ASCII_ACK_CHAR,          ASCII_BEL_CHAR,          ASCII_BS_CHAR,           ASCII_HT_CHAR,//9
    ASCII_LF_CHAR,           ASCII_VT_CHAR,           ASCII_FF_CHAR,           ASCII_CR_CHAR,           ASCII_SO_CHAR,//14
    ASCII_SI_CHAR,           ASCII_DLE_CHAR,          ASCII_DC1_CHAR,          ASCII_DC2_CHAR,          ASCII_DC3_CHAR,//19
    ASCII_DC4_CHAR,          ASCII_NACK_CHAR,         ASCII_SYN_CHAR,          ASCII_ETB_CHAR,          ASCII_CAN_CHAR,//24
    ASCII_EM_CHAR,           ASCII_SUB_CHAR,          ASCII_ESC_CHAR,          ASCII_FS_CHAR,           ASCII_GS_CHAR,//29
    ASCII_RS_CHAR,           ASCII_US_CHAR,           ASCII_SP_CHAR,           ASCII_EXCL_CHAR,         ASCII_QUOT_CHAR,//34
